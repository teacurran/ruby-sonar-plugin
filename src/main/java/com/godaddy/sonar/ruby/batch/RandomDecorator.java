package com.godaddy.sonar.ruby.batch;

//import com.godaddy.sonar.ruby.RubyMetrics;
...
public class RandomDecorator implements Decorator {
  ...
  public void decorate(Resource resource, DecoratorContext context) {
    ...
    if (Scopes.isBlockUnit(resource)) {
      ...
      //context.saveMeasure(RubyMetrics.RANDOM, value);

    } else {
      // we sum random values on resources different than method
      //context.saveMeasure(RubyMetrics.RANDOM, MeasureUtils.sum(true, context.getChildrenMeasures(RubyMetrics.RANDOM)));
    }
  }
